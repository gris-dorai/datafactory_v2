...
def ring__area(coordinates):
    ...
    @Returns
    {float} The approximate signed geodesic _area of the polygon in meters.
    """
...
def polygon__area(coordinates):
    ...
    if len(coordinates) > 0:
        ...
        #     _area -= (ring__area(coordinates[i]))
    # converting area in meters
    return sqrt(_area)
...
def area(geometry):
    ...
    # elif geometry['geom'] == 'GeometryCollection':
